...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deberia devolver null cuando un medico buscado existe pero no esta disponible en la fecha")
    ...
    @Test
    @DisplayName("Deberia devolver medico cuando el medico buscado existe y esta disponible en la fecha")
